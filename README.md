...
У меня локально запуск идет через pycharm - запускаю файл main.py 
После можно подключаться по telnet: `telnet 127.0.0.1 8000`
После нужно провести регистрацию/авторизацию
